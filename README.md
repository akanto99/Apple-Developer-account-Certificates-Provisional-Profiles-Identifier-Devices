...
1. [Mac এ Client Apple ID Login](#step-1--mac-এ-client-apple-id-login)
2. [Xcode ও macOS Version Check](#step-2--xcode-ও-macos-version-check)
3. [CSR File বানাও (Keychain Access)](#step-3--csr-file-বানাও-keychain-access)
4. [Identifier Create করো](#step-4--identifier-create-করো)
5. [iOS Distribution Certificate Create](#step-5--ios-distribution-certificate-create)
6. [iOS Development Certificate Create](#step-6--ios-development-certificate-create)
7. [Test Device Add করো](#step-7--test-device-add-করো)
8. [Provisioning Profile Create করো](#step-8--provisioning-profile-create-করো)
9. [Push Notification P12 Certificate](#step-9--push-notification-p12-certificate-বানাও)
10. [Xcode Final Setup ও Archive](#step-10--xcode-final-setup-ও-archive)
...
**কোথায় যাবে:** [developer.apple.com](https://developer.apple.com) → Certificates, Identifiers & Profiles → **Identifiers**
...
| Section | Item | Status |
|---------|------|--------|
| Certificates | Apple Push Services | ✅ Done |
| Certificates | iOS Development | ✅ Done |
| Certificates | iOS Distribution | ✅ Done |
| Certificates | Distribution Managed | ✅ Done |
| Identifiers | Dinmajur Customer | ✅ Done |
| Identifiers | OneSignal Extension | ✅ Done |
| Devices | SAIFUL's iPhone | ✅ Done |
| Profiles | App Store Distribution | ⚠️ Invalid — Recreate |
| Profiles | Development | ⚠️ Invalid — Recreate |
| P12 Export | Push Notification | 🔄 Export needed |
...
- [Apple Certificate Guide](https://developer.apple.com/support/certificates/)
